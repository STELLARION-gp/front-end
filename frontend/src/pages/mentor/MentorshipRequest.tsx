...
const MentorshipRequest: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", gap: "0.5rem" }}>
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              background:
                viewMode === "list" ? "#6366f1" : "rgba(255,255,255,0.1)",
              color: "#fff",
              cursor: "pointer",
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              background:
                viewMode === "cards" ? "#6366f1" : "rgba(255,255,255,0.1)",
              color: "#fff",
              cursor: "pointer",
            }}
          >
      ...
      {loading && (
        <div style={{ color: "#a0aec0", marginBottom: 12 }}>Loading...</div>
      )}
      {viewMode === "cards" ? (
        // Card View
        <div
        ...
        >
          {requests.map((req: Req) => (
            <div
              key={req.id}
              className="advanced-features mentor-profile-field-box"
              style={{
                display: "flex",
                alignItems: "center",
                gap: 24,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div
                  style={{ color: "#a0aec0", fontSize: "1rem", marginTop: 2 }}
                >
                  {req.details}
                </div>
                <div
              ...
              <div style={{ display: "flex", gap: 12, marginLeft: "auto" }}>
                <Button
                  className="mentor-btn-blue mentor-btn-small"
                  onClick={() => handleViewDetails(String(req.id))}
                >
                  Details
                </Button>
                <Button
                  className="mentor-btn-green mentor-btn-small"
                  onClick={() => handleAccept(String(req.id))}
                >
                  Accept
                </Button>
                <Button
                  className="mentor-btn-red mentor-btn-small"
      ...
      {selected && (
        <div className="mentee-modal-overlay" onClick={() => setSelected(null)}>
          <div className="mentee-modal" onClick={(e) => e.stopPropagation()}>
            <div className="mentee-modal-title">
              {selected.name || "Request Details"}
            </div>
            ...
            <div style={{ color: "#94a3b8", marginBottom: 12 }}>
              <strong>Goals:</strong> {selected.goals}
            </div>
            <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
              <Button
                className="mentor-btn-green"
                onClick={() => handleAccept(String(selected.id))}
              >
                Accept
              </Button>
              <Button
                className="mentor-btn-red"

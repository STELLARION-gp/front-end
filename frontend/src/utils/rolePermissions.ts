...
export const PAGE_ACCESS_CONTROL = {
    ...
    '/dashboard/booking-requests': ['enthusiast', 'influencer', 'learner', 'moderator', 'admin', 'guide'] as UserRole[],
...
export const ROLE_BASED_MENU_ITEMS = {
    learner: [
        ...
        { label: 'Booking Requests', icon: 'MoonIcon', href: '/dashboard/booking-requests' },

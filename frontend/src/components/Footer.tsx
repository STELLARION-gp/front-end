                ...
                <div className="footer-content">
                    ...
                    <div className="footer-brand">
                        ...
                        <div className="social-links">
                            ...
                            <a
                                ...
                                aria-label={t('footer.socialMedia.github')}
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/" className="text-theme4 hover:text-theme3 transition-colors duration-200">
                                    {t('footer.quickLinks.home')}
                                </Link>
                            </li>
                            <li>
                                <Link to="/about" className="text-theme4 hover:text-theme3 transition-colors duration-200">
                                    {t('footer.quickLinks.about')}
                                </Link>
                            </li>
                            <li>
                                <Link to="/dashboard" className="text-theme4 hover:text-theme3 transition-colors duration-200">
                                    {t('footer.quickLinks.dashboard')}
                                </Link>
                            </li>
                            <li>
                                <Link to="/login" className="text-theme4 hover:text-theme3 transition-colors duration-200">

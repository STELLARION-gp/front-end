...
import {
  nasaOpportunitiesService,
  type Opportunity,
} from "../../services/nasaOpportunitiesService";
  ...
  useEffect(() => {
    const fetchOpportunities = async () => {
      try {
        ...
        console.log(
          "Sample opportunity with image:",
          response.data.find((o) => o.image)
        );
  ...
  useEffect(() => {
    const filtered = opportunities.filter((opportunity) => {
      ...
      const matchesDifficulty =
        ...
        opportunity.difficulty === selectedDifficulty;
    ...
    <div className="nasa-opportunities-page">
      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Discover internships, volunteer opportunities, and citizen science
            projects with NASA. Join the next generation of space explorers and
          ...
          <div className="hero-stats">
            ...
            <div className="stat">
              <span className="stat-number">
                {opportunities.filter((o) => o.type === "volunteer").length}
              </span>
            ...
            <div className="stat">
              <span className="stat-number">
                {
                  opportunities.filter((o) => o.type === "citizen-science")
                    .length
                }
              </span>
              ...
              >
                ...
                <div className="opportunity-content">
                  <div className="opportunity-header">
                    <div
                      className={`opportunity-type ${getTypeColor(
                        opportunity.type
                      )}`}
                    >
                    ...
                    <div
                      className={`opportunity-difficulty ${getDifficultyColor(

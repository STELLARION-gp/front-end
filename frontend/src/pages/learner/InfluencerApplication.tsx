...
const InfluencerApplication = () => {
  ...
  const handleArrayChange = (
    name: "specialization_tags" | "sample_content_links" | "tools_used",
    idx: number,
    value: string
  ) => {
    setForm((prev) => {
  ...
  const handleSocialLinkChange = (
    platform: keyof typeof form.social_links,
    value: string
  ) => {
    setForm((prev) => ({
      ...prev,
    ...
    <div className={styles["guide-app-bg"]}>
      <div className={styles["guide-app-container"]}>
        ...
        <p className={styles["guide-app-desc"]}>
          Please fill out this form to apply as an Influencer. Provide accurate
          and complete information. All fields are required unless marked
          optional.
        </p>
        <form onSubmit={handleSubmit} className={styles["guide-app-form"]}>
          ...
          <div>
            ...
            {form.specialization_tags.map((tag, idx) => (
              <div key={idx} className={styles["guide-row"]}>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleRemoveArrayItem("specialization_tags", idx)
                  }
            ...
            <button
              type="button"
              onClick={() => handleAddArrayItem("specialization_tags")}
              className={styles["guide-btn-link"]}
            >
              Add Tag
            </button>
          </div>
          ...
          <div>
            ...
            {form.sample_content_links.map((link, idx) => (
              <div key={idx} className={styles["guide-row"]}>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleRemoveArrayItem("sample_content_links", idx)
                  }
                  className={styles["guide-remove-btn"]}
                  aria-label="Remove"
                >
            ...
            <button
              type="button"
              onClick={() => handleAddArrayItem("sample_content_links")}
              className={styles["guide-btn-link"]}
            >
              Add Link
            </button>
            ...
            <label className={styles["guide-checkbox-label"]}>
              <input
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    willing_to_host_sessions: e.target.checked,
                  }))
                }
          ...
          <div>
            ...
            {form.tools_used.map((tool, idx) => (
              <div key={idx} className={styles["guide-row"]}>
                <InputField
                  ...
                  value={tool}
                  onChange={(e) =>
                    handleArrayChange("tools_used", idx, e.target.value)
                  }
                  placeholder="Tool"
                />
                <button
            ...
            <button
              type="button"
              onClick={() => handleAddArrayItem("tools_used")}
              className={styles["guide-btn-link"]}
            >
              Add Tool
            </button>

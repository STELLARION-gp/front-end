...
const EditMentor = () => {
  ...
  const handleSaveVideo = () => {
    ...
    if (match) {
      ...
      navigate("/dashboard/mentorprofile", {
        state: { video: `https://www.youtube.com/embed/${match[1]}` },
      });
    }
  };
  ...
  return (
    <div className="dashboard-page">
      ...
      <div
        className="mentor-profile-layout"
        style={{ display: "flex", gap: "2.5rem", flexWrap: "wrap" }}
      >
        {/* Left Card */}
        <div
          className="mentor-profile-left"
          style={{ minWidth: 500, maxWidth: 500, flex: "0 0 500px" }}
        >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                {[1, 2, 3, 4, 5].map((i) => (
                  <StarIcon
                    ...
                    style={{
                      width: 20,
                      color: i <= form.rating ? "#fbbf24" : "#cbd5e1",
                      cursor: "pointer",
                    }}
                ...
                <span
                  ...
                  style={{ color: "#a0aec0", fontWeight: 500, marginLeft: 8 }}
                >{`Rated ${form.rating}.0/5.0`}</span>
                <br />
              </div>
            </div>
          </div>
          {/* Intro Video Section */}
          <div
            className="advanced-features mentor-profile-field-box mentor-profile-intro-video"
            style={{ marginTop: 50 }}
          >
            <label>Intro Video</label>
            <div
              className="mentor-profile-field-value"
              style={{
                display: "flex",
            ...
            >
              <Button className="w-full" onClick={handleVideoPopup}>
                Get Link
              </Button>
            </div>
            {showVideoPopup && (
            ...
            >
              <button
                className="logout-modal-button logout-modal-button--confirm w-full"
                style={{ background: "#22c55e", color: "white" }}
                onClick={handleSave}
              >
                Save
              ...
              <button
                className="logout-modal-button logout-modal-button--cancel w-full"
                style={{
                  background: "#ef4444",
                  color: "white",
                  border: "1px solid #ef4444",

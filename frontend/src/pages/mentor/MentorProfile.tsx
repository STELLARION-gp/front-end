...
import avatarImg from "../../assets/world.webp"; // Use your actual avatar asset path
    ...
    <div className="dashboard-page">
      ...
      >
        ...
        <div
          ...
          style={{ minWidth: 500, maxWidth: 500, flex: "0 0 400px" }}
        >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
                {[1, 2, 3, 4, 5].map((i) => (
                  <StarIcon
                    ...
                    style={{
                      width: 20,
                      color: i <= profile.rating ? "#fbbf24" : "#cbd5e1",
                    }}
                  />
                ))}
                <span
                ...
                >{`Rated ${profile.rating}.0/5.0`}</span>
                <br />
              </div>
            </div>
          </div>
          <div style={{ marginTop: 32, width: "80%" }}>
            <Button className="w-full">Check Reviews</Button>
          </div>
        ...
        >
          ...
          <div className="advanced-features mentor-profile-field-box">
            ...
            <div className="mentor-profile-field-value">

...
const Followers: React.FC = () => {
  ...
  const messageHistories: {
    [followerId: string]: { sender: string; text: string; timestamp: string }[];
  } = {
    "1": [
      {
        sender: "Sarah Johnson",
        text: "Thanks for the amazing astronomy content!",
    ...
    "2": [
      {
        sender: "Miky Chen",
        text: "Can you share more about the next event?",
        timestamp: "2024-06-02 09:00",
      },
      {
        sender: "You",
        text: "Sure, I will post details soon.",
        timestamp: "2024-06-02 09:10",
      },
    ],
  };
            ...
            history.map((msg, idx) => (
              <div
                ...
                className={`chat-modal__message ${
                  msg.sender === "You"
                    ? "chat-modal__message--me"
                    : "chat-modal__message--them"
                }`}
              >
    ...
    <div className="page-container">
      ...
      <div className="content-container">
        <div className="tab-navigation">
          <Button
            className={`tab-btn ${
              activeTab === "followers" ? "primary" : "secondary"
            }`}
          ...
          <Button
            className={`tab-btn ${
              activeTab === "requests" ? "primary" : "secondary"
            }`}
          ...
          <Button
            className={`tab-btn ${
              activeTab === "messages" ? "primary" : "secondary"
            }`}
            ...
            <div className="followers-section">
              ...
              {followers.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Start creating amazing astronomy content to build your
                    community!
                  </p>
                </div>
              )}
            ...
            <div className="requests-section">
              ...
              {followRequests.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    You're all caught up! No new follow requests at this time.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="messages-section">
              ...
              {messages.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Start conversations with your followers to build engagement!
                  </p>
                </div>
              )}
            </div>
      ...
      {modalOpen && (
        <div className="chat-modal__overlay">
          <div className="chat-modal__container">{modalContent}</div>
        </div>
      )}
    </div>
  );
